...
export default function MovieCard({
  ...
  return (
    <div className="relative hover:scale-105 transition-all duration-1000 ease-linear cursor-pointer">
      <Link
        {...props}
    ...
    overflow-hidden flex flex-col justify-center items-center
      ...
      >
        ...
        <div className="flex flex-col gap-1 justify-center items-center w-full pt-1 px-2 z-10">
      ...
      <div className="absolute top-2 right-2 z-10">
        <Like
          movieId={movie.id}
          onClick={toggleLike ? () => toggleLike(movie.id) : undefined}
        />
      </div>
    </div>
  );
